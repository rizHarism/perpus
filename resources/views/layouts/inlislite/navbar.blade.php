    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user-menu">
            ...
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="#" class="user-image img-circle img-thumbnail elevation-2" alt="ADMIN">
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-header h-auto">
                    <img src="#" class="img-circle img-thumbnail elevation-2" alt="ADMIN">

                    <p class=" mt-0"> ADMIN <small>ADMINISTRATOR</small>
                    </p>
                </li>
